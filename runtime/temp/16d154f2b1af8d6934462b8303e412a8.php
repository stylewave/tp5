<?php /*a:2:{s:66:"F:\xampp\htdocs\yangxing/application/admin/view\cate\typelist.html";i:1524819671;s:65:"F:\xampp\htdocs\yangxing/application/admin/view\layout\index.html";i:1530006503;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
      ...
      <div class="box">
        ...
        <div class="box-body">
         ...
         <?php foreach($list as $li): ?>
            <tr>
              <td><a href="<?php echo Url::build('admin/Cate/cateList',['tid'=>$li['id']]); ?>" ><?php echo htmlentities($li['id']); ?></a></td>
              <td><a href="<?php echo Url::build('admin/Cate/cateList',['tid'=>$li['id']]); ?>" ><?php echo htmlentities($li['title']); ?></a></td>
              <td><?php echo htmlentities($li['num']); ?></td>
              <td><?php echo htmlentities($li['addtime']); ?></td>
              <td><?php if($li['hexin'] == 1): ?>系统内置类别，不可操作<?php else: ?><a href="<?php echo Url::build('admin/Cate/addType',['id'=>$li['id']]); ?>" style="color: #333333;"><i class="fa fa-edit"></i> 修改</a>&nbsp;&nbsp;  <a href="javascript:void(0);" style="color: #333333;" onclick="isdel('您确定要删除这个类别吗？','<?php echo Url::build('admin/Cate/delType',['id'=>$li['id']]); ?>');"><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?></td>
            </tr>
         <?php endforeach; ?>
            </tbody>
            <!--<tfoot>-->
