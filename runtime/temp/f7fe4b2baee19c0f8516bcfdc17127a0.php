<?php /*a:2:{s:68:"F:\xampp\htdocs\yangxing/application/admin/view\store\storelist.html";i:1536213766;s:65:"F:\xampp\htdocs\yangxing/application/admin/view\layout\index.html";i:1530006503;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
      ...
      <div class="box">
        ...
        <div class="box-body" >
          ...
          <table id="example1" class="table table-bordered table-striped table-hover">
            ...
            <tr>
                <td><?php echo htmlentities($li['city']); ?></td>
                <td><?php echo htmlentities($li['address']); ?></td>
                <td><?php echo htmlentities($li['username']); ?></td>
                <td><?php echo htmlentities($li['en_username']); ?></td>
                <td><?php echo htmlentities($li['tel']); ?></td>
                <td><?php echo htmlentities($li['mobile']); ?></td>
                <td><?php echo htmlentities($li['email']); ?></td>
                <td><?php echo htmlentities($li['qq']); ?></td>
                <td><?php echo htmlentities($li['addtime']); ?></td>
                <td><a href="<?php echo Url::build('admin/Store/store',['id'=>$li['id']]); ?>"><i class="fa fa-edit"></i> 修改</a>&nbsp;&nbsp;  <a href="javascript:void(0);" onclick="isdel('您确定要删除这个门店信息吗？','<?php echo Url::build('admin/Store/del',['id'=>$li['id']]); ?>');"><i class="fa fa-trash-o"></i> 删除</a></td>
            </tr>
         <?php endforeach; ?>
            </tbody>
          </table>
...
<script>
    $(function(){
        ...
        $(".pjaxchangge").change(function(){
            ...
            $.pjax({
                url: "<?php echo Url::build('admin/Store/storelist'); ?>"+selectstr,
