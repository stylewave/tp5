<?php /*a:5:{s:75:"F:\xampp\htdocs\yangxing/application/index/view\english\en_news_detail.html";i:1536314707;s:66:"F:\xampp\htdocs\yangxing/application/index/view\public\styles.html";i:1536285306;s:69:"F:\xampp\htdocs\yangxing/application/index/view\public\en_header.html";i:1536286250;s:65:"F:\xampp\htdocs\yangxing/application/index/view\public\right.html";i:1536226884;s:69:"F:\xampp\htdocs\yangxing/application/index/view\public\en_footer.html";i:1536290326;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta  charset="UTF-8">
    <title><?php echo htmlentities($data['stitle']); ?> - <?php echo htmlentities($config['en_name']); ?></title>
...
<!-- banner -->
    ...
    <?php endif; endforeach; ?>
        <div class="tit"><?php echo htmlentities($detail['en_title']); ?></div>
        <p>news center</p>
    </section>
<!-- banner end -->
    ...
    <div class="page-main">
        <div class="warp">
            <div class="pm-nav">
                ...
                <span>></span>
                <a href="<?php echo Url::build('/en_news'); ?>">News</a>
                <span>></span>
                <a href="javascript:;"><?php echo htmlentities($detail['en_title']); ?></a>
            </div>
            <section class="pm-left">
                <div class="pl-tit2">
                    <h1><?php echo htmlentities($data['stitle']); ?></h1>
                    <div class="plc-time">
                        <span>Release Date：<?php echo htmlentities(date('Y-m-d',!is_numeric($data['publishtime'])? strtotime($data['publishtime']) : $data['publishtime'])); ?></span><span>Read：<?php echo htmlentities($data['click']); ?></span>
                    </div>
                </div>
                <div class="pl-cont">
