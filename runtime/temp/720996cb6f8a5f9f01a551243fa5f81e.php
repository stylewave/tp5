<?php /*a:2:{s:59:"/opt/www/8915/application/admin/view/banner/bannerlist.html";i:1536541711;s:54:"/opt/www/8915/application/admin/view/layout/index.html";i:1536541712;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="box-body" >
          ...
          <table id="example1" class="table table-bordered table-striped table-hover">
            ...
            <tr>
                ...
                <td><?php echo htmlentities($li['url']); ?></td>
                <td><?php echo htmlentities($catelist[$li['cateid']]['title']); ?></td>
                <td>
                    <?php if($li['ist'] == 1): ?>
                    <a href="javascript:void(0);" onclick="isdo('确定不显示图片吗？','<?php echo Url::build('admin/Banner/ajaxBanner',['id'=>$li['id'],'do'=>'qxtj']); ?>',this);">
                        <i class="fa fa-check"> 是</i>
                    </a>
                    <?php else: ?>
                    <a href="javascript:void(0);"  onclick="isdo('确定要显示这个图片吗？','<?php echo Url::build('admin/Banner/ajaxBanner',['id'=>$li['id'],'do'=>'tj']); ?>',this);">
                        <i class="fa fa-ban"> 否</i>
                    </a>
                    <?php endif; ?>
                </td>
                <td><input style="text-align: center;" type="text" tipvalue="cateordertip<?php echo htmlentities($i); ?>" size="3" value="<?php echo htmlentities($li['orders']); ?>" onblur="isdo('','<?php echo Url::build('admin/Banner/ajaxBanner',['id'=>$li['id'],'do'=>'order']); ?>',this);"/> <span class="icon icon-cateordertip<?php echo htmlentities($i); ?> margin-small" ></span></td>
                <td><?php echo empty($li['img']) ? '没有图片' : '<a href="'.$li['img'].'" target="_blank"><img src="'.$li['img'].'" width="150" height="50"></a>'; ?></td>
                <td><?php echo htmlentities($li['addtime']); ?></td>
                <td><a href="<?php echo Url::build('admin/Banner/banner',['id'=>$li['id']]); ?>"><i class="fa fa-edit"></i> 修改</a>&nbsp;&nbsp;  <a href="javascript:void(0);" onclick="isdel('您确定要删除这个图片吗？','<?php echo Url::build('admin/Banner/del',['id'=>$li['id']]); ?>');"><i class="fa fa-trash-o"></i> 删除</a></td>
            </tr>
         <?php endforeach; ?>
            </tbody>
          </table>
...
<script>
    $(function(){
        ...
        $(".pjaxchangge").change(function(){
            ...
            $.pjax({
                url: "<?php echo Url::build('admin/Banner/bannerlist'); ?>"+selectstr,
