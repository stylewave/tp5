<?php /*a:5:{s:68:"F:\xampp\htdocs\yangxing/application/index/view\english\en_news.html";i:1536314685;s:66:"F:\xampp\htdocs\yangxing/application/index/view\public\styles.html";i:1536285306;s:69:"F:\xampp\htdocs\yangxing/application/index/view\public\en_header.html";i:1536286250;s:65:"F:\xampp\htdocs\yangxing/application/index/view\public\right.html";i:1536226884;s:69:"F:\xampp\htdocs\yangxing/application/index/view\public\en_footer.html";i:1536290326;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta  charset="UTF-8">
    ...
    <div class="page-main">
        <div class="warp">
            <div class="pm-nav">
                ...
                <span>></span>
                <a href="<?php echo Url::build('/'.$title['en_url']); ?>">News</a>
                <span>></span>
                <a href="javascript:;"><?php echo htmlentities($title['en_title']); ?></a>
            </div>
            <section class="pm-left">
                <div class="pl-tit"><?php echo htmlentities($title['en_title']); ?></div>
                <ol class="pml-news">
                    <?php foreach($list as $li): ?>
                    <li>
                        <div class="left"><a href="<?php echo Url::build('/en_news_detail'); ?>?id=<?php echo htmlentities($li['id']); ?>"><img src="<?php echo htmlentities($li['img']); ?>" alt=""></a></div>
                        <div class="cen">
                            <a href="<?php echo Url::build('/en_news_detail'); ?>?id=<?php echo htmlentities($li['id']); ?>"><h3><?php echo htmlentities($li['stitle']); ?></h3></a>
                            <p><?php echo htmlentities(getSubstr($li['en_desc'],0,164)); ?></p>
                        </div>
                        <div class="right">
                        ...
                        <div class="bottom"><a href="<?php echo Url::build('/en_news_detail'); ?>?id=<?php echo htmlentities($li['id']); ?>">More></a></div>
                    </li>
                    <?php endforeach; ?>
                </ol>
                <div class="page">
