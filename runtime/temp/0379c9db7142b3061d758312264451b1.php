<?php /*a:2:{s:55:"/opt/www/8915/application/admin/view/rbac/rbaclist.html";i:1536541713;s:54:"/opt/www/8915/application/admin/view/layout/index.html";i:1536541712;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="box-body">
         ...
         <?php foreach($list as $li): ?>
            <tr>
              ...
              <td><?php echo $li['pre']; ?></td>
              <td><?php echo htmlentities($li['addtime']); ?></td>
              <td><a href="<?php echo Url::build('admin/Rbac/addRbac',['id'=>$li['id']]); ?>"><i class="fa fa-edit"></i> 修改</a>&nbsp;&nbsp;  <a href="javascript:void(0);" onclick="isdel('您确定要删除这个权限组吗？','<?php echo Url::build('admin/Rbac/delRbac',['id'=>$li['id']]); ?>');"><i class="fa fa-trash-o"></i> 删除</a></td>
            </tr>
         <?php endforeach; ?>
            </tbody>
          </table>
