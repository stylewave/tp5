<?php /*a:2:{s:53:"/opt/www/8915/application/admin/view/store/store.html";i:1536541713;s:54:"/opt/www/8915/application/admin/view/layout/index.html";i:1536541712;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="nav-tabs-custom" style="margin-top: 20px;">
        ...
        <form action="<?php echo Url::build('admin/Store/store');; ?>" enctype="multipart/form-data" method="post" name="qxform" id="qxform">
            ...
            <section id="new">
              ...
              <div class="row fontawesome-icon-list">
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>地点：</label>
                  <input type="text" style="color: #444444;width: 80%" id="city" name="city" value="<?php echo htmlentities($info['city']); ?>"> <span class="icon icon-city margin-small" ></span>
                </div>
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>地点(英)：</label>
                  <input type="text" style="color: #444444;width: 80%" id="en_city" name="en_city" value="<?php echo htmlentities($info['en_city']); ?>"> <span class="icon icon-en_city margin-small" ></span>
                </div>
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>地址：</label>
                  <input type="text" style="color: #444444;width: 80%" id="address" name="address" value="<?php echo htmlentities($info['address']); ?>"> <span class="icon icon-address margin-small" ></span>
                </div>
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>地址(英)：</label>
                  <input type="text" style="color: #444444;width: 80%" id="en_address" name="en_address" value="<?php echo htmlentities($info['en_address']); ?>">
                </div>
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>联系人：</label>
                  <input type="text" style="color: #444444;width: 80%" name="username" value="<?php echo htmlentities($info['username']); ?>">
                </div>
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>联系人(英)：</label>
                  <input type="text" style="color: #444444;width: 80%" name="en_username" value="<?php echo htmlentities($info['en_username']); ?>">
                </div>
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>电话：</label>
                  <input type="text" style="color: #444444;width: 80%" name="tel" value="<?php echo htmlentities($info['tel']); ?>">
                </div>
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>手机：</label>
                  <input type="text" style="color: #444444;width: 80%" name="mobile" value="<?php echo htmlentities($info['mobile']); ?>">
                </div>
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>QQ：</label>
                  <input type="text" style="color: #444444;width: 80%" name="qq" value="<?php echo htmlentities($info['qq']); ?>">
                </div>
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>邮箱：</label>
                  <input type="text" style="color: #444444;width: 80%" name="email" value="<?php echo htmlentities($info['email']); ?>">
                </div>
              </div>
            </section>
          </div>
...
<script>
    function qxsubmit() {
        if($('#title').val() == '') {
            tips('请填写地址！','.icon-address','address');
            return false;
        }
