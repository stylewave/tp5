<?php /*a:2:{s:66:"F:\xampp\htdocs\yangxing/application/admin/view\cate\catelist.html";i:1531900041;s:65:"F:\xampp\htdocs\yangxing/application/admin/view\layout\index.html";i:1530006503;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
          ...
          <div class="col-sm-6" style="width: 100%">
              ...
              <div class="col-md-3 col-sm-4" style="line-height: 40px;margin-top: 15px;">
                  <div class="form-group">
                      ...
                      <option value="<?php echo htmlentities($user['id']); ?>"><?php if($user['dj'] > 0)  {echo str_repeat(" L__ ",$user['dj'])." ";} ?><?php echo htmlentities($user['title']); ?></option>
                      <?php endforeach; ?>
                  </select>
                  </div>
              </div>
              <div class="col-md-3 col-sm-4" style="line-height: 40px;margin-top: 15px;">
                <div class="form-group">
                  ...
                  <?php foreach($tall as $logkey=>$log): ?>
                    <option  value="<?php echo htmlentities($logkey); ?>" <?php if($tinfo['id'] == $logkey): ?>selected<?php endif; ?>><?php echo htmlentities($log['title']); ?></option>
                  <?php endforeach; ?>
                </select>
                </div>
              </div>
...
<script>
    $(function(){
        $('#tid').change(function(){
            window.location.href="<?php echo Url::build('admin/Cate/cateList'); ?>?tid="+$(this).val();
        })
        ...
        $(".pjaxchangge").change(function(){
            ...
            $.pjax({
                url: "<?php echo Url::build('admin/Cate/cateList'); ?>?tid=<?php echo htmlentities($tinfo['id']); ?>"+selectstr,
