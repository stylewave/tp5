<?php /*a:2:{s:54:"/opt/www/8915/application/admin/view/cate/addtype.html";i:1536541712;s:54:"/opt/www/8915/application/admin/view/layout/index.html";i:1536541712;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="col-xs-12">
      <div class="nav-tabs-custom" style="margin-top: 20px;">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#fa-icons-server" data-toggle="tab"><?php if(isset($info) && !empty($info)): ?>修改<?php else: ?>添加<?php endif; ?>分类类别</a></li>
        </ul>
        <div class="tab-content">
          <div class="tab-pane active" id="fa-icons-server">
            <form action="<?php echo Url::build('admin/Cate/addType');; ?>" method="post" name="qxform" id="qxform">
              <input type="hidden" name="__token__" value="<?php echo htmlentities(app('request')->token()); ?>" />
              <input type="hidden" name="id" id="infoid" value="<?php if($info): ?><?php echo htmlentities($info['id']); endif; ?>" />
            <section id="new">
              <!--<h4 class="page-header">类别信息</h4>-->

              <div class="row fontawesome-icon-list">
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;text-indent: 10px">
                  类别名称/标题：<input type="text" style="color: #444444;width: 80%" id="title" name="title" value="<?php if($info): ?><?php echo htmlentities($info['title']); endif; ?>"> <span style="color: red">*</span><span class="icon icon-username margin-small" ></span>
                </div>
              </div>
            </section>
...
<script>
  function qxsubmit() {
    if($('#title').val() == '') {
        tips('请填写类别名称！','.icon-username','title');
        return false;
    }
