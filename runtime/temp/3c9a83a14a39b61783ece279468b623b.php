<?php /*a:5:{s:71:"F:\xampp\htdocs\yangxing/application/index/view\english\en_partner.html";i:1536314451;s:66:"F:\xampp\htdocs\yangxing/application/index/view\public\styles.html";i:1536285306;s:69:"F:\xampp\htdocs\yangxing/application/index/view\public\en_header.html";i:1536286250;s:65:"F:\xampp\htdocs\yangxing/application/index/view\public\right.html";i:1536226884;s:69:"F:\xampp\htdocs\yangxing/application/index/view\public\en_footer.html";i:1536290326;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta  charset="UTF-8">
...
<!-- header end --> 
<!-- banner -->
    <?php foreach($banner as $ban): if($ban['cateid'] == 131): ?>
    ...
    <div class="page-main">
        <div class="warp">
            ...
            <section class="pm-left">
                ...
                <ul class="page-partner">
                    <?php foreach($list as $li): ?>
                    <li><img src="<?php echo htmlentities($li['img']); ?>" alt=""></li>
                    <?php endforeach; ?>
                </ul>
                <div class="page">
            ...
            <aside class="pm-right">
                <dl>
                    <dt><?php echo htmlentities($title['en_title']); ?></dt>
                    <dd class="pr-active"><a href="<?php echo Url::build('/en_partner'); ?>"><?php echo htmlentities($title['en_title']); ?></a></dd>
                </dl>
                <div class="img">
