<?php /*a:2:{s:55:"/opt/www/8915/application/admin/view/rbac/userlist.html";i:1536541713;s:54:"/opt/www/8915/application/admin/view/layout/index.html";i:1536541712;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="box-body">
         ...
         <?php foreach($list as $li): ?>
            <tr>
              ...
              <td><?php echo htmlentities($li['pres']); ?></td>
              <td><?php echo htmlentities($li['logintime']); ?></td>
              <td><?php echo htmlentities($li['loginip']); ?></td>
              <td><?php echo htmlentities($li['addtime']); ?></td>
              <td><?php if($li['pre'] == -1): ?>--<?php else: ?><a href="<?php echo Url::build('admin/Rbac/addUser',['id'=>$li['id']]); ?>"><i class="fa fa-edit"></i> 修改</a>&nbsp;&nbsp;  <a href="javascript:void(0);" onclick="isdel('您确定要删除这个用户吗？','<?php echo Url::build('admin/Rbac/delUser',['id'=>$li['id']]); ?>');"><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?></td>
            </tr>
         <?php endforeach; ?>
            </tbody>
          </table>
