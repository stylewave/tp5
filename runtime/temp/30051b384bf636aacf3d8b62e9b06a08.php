<?php /*a:5:{s:59:"/opt/www/8915/application/index/view/index/news_detail.html";i:1536541714;s:54:"/opt/www/8915/application/index/view/public/style.html";i:1536541715;s:55:"/opt/www/8915/application/index/view/public/header.html";i:1536541715;s:54:"/opt/www/8915/application/index/view/public/right.html";i:1536541715;s:55:"/opt/www/8915/application/index/view/public/footer.html";i:1536541715;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title><?php echo htmlentities($data['title']); ?> - <?php echo htmlentities($config['title']); ?></title>
...
<!-- banner -->
    ...
    <?php endif; endforeach; ?>
        <div class="tit"><?php echo htmlentities($detail['title']); ?></div>
        <p><?php echo htmlentities($detail['en_title']); ?></p>
    </section>
<!-- banner end -->
    ...
    <div class="page-main">
        <div class="warp">
            <div class="pm-nav">
                <a href="/">首页</a>
                <span>></span>
                <a href="<?php echo Url::build('/news'); ?>">新闻中心</a>
                <span>></span>
                <a href="javascript:;"><?php echo htmlentities($detail['title']); ?></a>
            </div>
            <section class="pm-left">
                <div class="pl-tit2">
                    <h1><?php echo htmlentities($data['title']); ?></h1>
                    <div class="plc-time">
                        <span>发布日期：<?php echo htmlentities(date('Y-m-d',!is_numeric($data['publishtime'])? strtotime($data['publishtime']) : $data['publishtime'])); ?></span><span>阅读：<?php echo htmlentities($data['click']); ?></span>
                    </div>
                </div>
                <div class="pl-cont">
                    <?php echo $data['ms']; ?>
