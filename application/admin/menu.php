...
//    ],
    ...
    'Store' => [
        ...
        'pre'   => true,
        'menu'  =>[
            'storelist' => ['title'=>'地址列表', 'inco'=>'fa-circle', 'pre'=>true, 'isshow'=>true],
            'store' => ['title'=>'添加地址', 'inco'=>'fa-circle', 'pre'=>true, 'isshow'=>true],
        ]
    ],
    //留言管理
    'Message' => [
        ...
        'pre'   => true,
        'menu'  =>[
            'messagelist' => ['title'=>'在线留言', 'inco'=>'fa-circle', 'pre'=>true, 'isshow'=>true],
//            'onlinelist' => ['title'=>'在线留言(英)', 'inco'=>'fa-circle', 'pre'=>true, 'isshow'=>true],
        ]
    ],
    //权限组 三级管理栏目示例
    'Rbac' => [
