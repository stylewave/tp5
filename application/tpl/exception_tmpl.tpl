...
<div class="b">
    ...
    <p>
        暂时未能找到您查找的页面<br>
        可能输入的网址错误或此页面不存在<br>
        <span id="num"></span>秒后自动跳转到主页<br><br>

        You can't find the page you searched for temporarily.<br>
        The web address that may be entered is incorrect or this page does not exist.<br>
        Automatically jump to the home page after <span id="nums"></span> seconds.
    </p>
</div>
